...
export const Services = [
  {
    service: [
      ...
      {
        id: 2,
        title: "Mezzanine Floor Racking System",
        slug: "mezzanine-floor-racking-system",
        description: "Complete pallet rack install/teardown provided for you",
        price: 99.99,
        isFeatured: true,
      ...
      {
        id: 4,
        title: "Push Back Racking System",
        slug: "push-back-rackings-system",
        description: "Complete pallet rack install/teardown provided for you",
        price: 99.99,
        isFeatured: true,
      ...
      {
        id: 5,
        title: "Pallet Flow Racks",
        slug: "pallet-flow-racks",
        description: "Complete pallet rack install/teardown provided for you",
        price: 99.99,
        isFeatured: true,
      ...
      {
        id: 6,
        title: "Carton Flow Racks",
        slug: "carton-flow-racks",
        description: "Complete pallet rack install/teardown provided for you",
        price: 99.99,
        isFeatured: true,
      ...
      {
        id: 7,
        title: "Teardrop Pallet Racking",
        slug: "teardrop-pallet-racking",
        description: "Complete pallet rack install/teardown provided for you",
        price: 99.99,
        isFeatured: true,
      ...
      {
        id: 9,
        title: "Used Pallet Racking",
        slug: "used-pallet-racking",
        description: "Complete pallet rack install/teardown provided for you",
        price: 99.99,
        isFeatured: true,
